...
?>
        ...
        <a class="navbar-brand" href="<?php echo get_home_url(); ?>"> <img src="<?php bloginfo('template_url'); ?>/img/logo.png" class="w-60" alt="<?php bloginfo('name'); ?>" title="<?php bloginfo('name'); ?>" /></a>
